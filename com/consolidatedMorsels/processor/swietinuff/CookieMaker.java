...
public class CookieMaker extends BaseTreatMaker {

	private static String MY_CLASSNAME = CookieMaker.class.getName();

	public CookieMaker(Hashtable aHashParameters) {
